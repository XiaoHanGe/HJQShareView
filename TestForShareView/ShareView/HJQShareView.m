...
#pragma mark - HJQShareView

@interface HJQShareView ()
...
//    [self.cancelButton setTitle:@"取 消" forState:UIControlStateNormal];
    [self.cancelButton setImage:[UIImage imageNamed:@"cancleButtons"] forState:UIControlStateNormal];
