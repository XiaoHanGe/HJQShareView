...
//添加buttonView, HJQShareView会根据buttonView的数量自动变高, 但是没有对高度上限做过多处理，莫要丧心病狂的添加太多.
